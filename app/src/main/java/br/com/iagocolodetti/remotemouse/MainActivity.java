...
public class MainActivity extends AppCompatActivity {
    ...
    private void startMouseCursor(View v, int direction) {
        if (!rm.isClosed()) {
            ...
            if (pixels >= MIN_PIXELS && pixels <= MAX_PIXELS) {
                if (delay >= MIN_DELAY && delay <= MAX_DELAY) {
                    if (threadMouseCursor == null) {
                        ...
                        mouseCursor = new ThreadMouseCursor(rm, pixels, direction, delay);
    ...
    private void startMouseScroll(View v, int direction) {
        if (!rm.isClosed()) {
    ...
    private void restorePreferences() {
        ...
        etPixels.setText(preferences.getString("etPixels", "10"));
        etDelay.setText(preferences.getString("etDelay", "1"));
    }
}
